...
all_data = pd.DataFrame(nodes)[293000:840196]
print(all_data.shape)
data = all_data.drop_duplicates()[50000:70000]
#print(unique_data.shape)
#data.to_csv('data_4570.csv')
"""
...
ct = 0
for index, row in data.iterrows():
    if ct>=0 and ct<25000: #day5
        ct += 1
        fi = str(row['census'])[1:] + "_" + str(row['lat']) + "_" + str(row['lon'])
...
with open('la_crime_data/images/image_list_363000.dat', 'wb') as outfile:
