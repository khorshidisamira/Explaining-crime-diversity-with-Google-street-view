...
res <- cor(scaled_data)
# Write CSV in R
write.csv(res, file = "la_crime_data/new_data/pairwise_all_correlation.csv")
...
abline(a=0,b=1)
jpeg(file = "C:/Users/Samira/Dropbox/Dr Mohler/Crime discovery/la_crime_data/result/GWR_ERRORSLM_all_variables/1.jpeg")
plot(model1, which=1) # residuals against fitted values
dev.off()

jpeg(file = "C:/Users/Samira/Dropbox/Dr Mohler/Crime discovery/la_crime_data/result/GWR_ERRORSLM_all_variables/2.jpeg")
plot(model1, which=2) # Normal Q-Q
dev.off()

jpeg(file = "C:/Users/Samira/Dropbox/Dr Mohler/Crime discovery/la_crime_data/result/GWR_ERRORSLM_all_variables/3.jpeg")
plot(model1, which=3) # a Scale-Location plot of sqrt(| residuals |) against fitted values
dev.off()

jpeg(file = "C:/Users/Samira/Dropbox/Dr Mohler/Crime discovery/la_crime_data/result/GWR_ERRORSLM_all_variables/4.jpeg")
plot(model1, which=4) # Cook's distance
dev.off()

jpeg(file = "C:/Users/Samira/Dropbox/Dr Mohler/Crime discovery/la_crime_data/result/GWR_ERRORSLM_all_variables/5.jpeg")
plot(model1, which=5) # residuals against leverage
dev.off()

jpeg(file = "C:/Users/Samira/Dropbox/Dr Mohler/Crime discovery/la_crime_data/result/GWR_ERRORSLM_all_variables/6.jpeg")
...
jpeg(file = "C:/Users/Samira/Dropbox/Dr Mohler/Crime discovery/la_crime_data/result/GWR_ERRORSLM_all_variables/histogram of actual with density of linear.jpeg")
...
jpeg(file = "C:/Users/Samira/Dropbox/Dr Mohler/Crime discovery/la_crime_data/result/GWR_ERRORSLM_all_variables/histogram of actual with density of gwr.jpeg")
par(mfrow=c(1,1))
hist(plot_df$crimes_shannon_index, # histogram
     col="gray", # column color
     border="black",
...
jpeg(file = "C:/Users/Samira/Dropbox/Dr Mohler/Crime discovery/la_crime_data/result/GWR_ERRORSLM_all_variables/gwr value against the actual value.jpeg")
#Plot the predicted value against the actual value
...
jpeg(file = "C:/Users/Samira/Dropbox/Dr Mohler/Crime discovery/la_crime_data/result/GWR_ERRORSLM_all_variables/GWR residuals against gwr value.jpeg")
...
jpeg(file = "C:/Users/Samira/Dropbox/Dr Mohler/Crime discovery/la_crime_data/result/GWR_ERRORSLM_all_variables/density of predicted gwr.jpeg")
#Plot density of predicted crime diversity
plot_density(scaled_data, gwr_pred, "density", "predicted crimes diversity index with GWR")
dev.off()

jpeg(file = "C:/Users/Samira/Dropbox/Dr Mohler/Crime discovery/la_crime_data/result/GWR_ERRORSLM_all_variables/count density of predicted gwr.jpeg")
plot_density(scaled_data, gwr_pred, "count", "predicted crimes diversity index with GWR")
dev.off()

#Plot histogram of crime diversity
jpeg(file = "C:/Users/Samira/Dropbox/Dr Mohler/Crime discovery/la_crime_data/result/GWR_ERRORSLM_all_variables/histogram of predicted gwr.jpeg")
...
ggsave("C:/Users/Samira/Dropbox/Dr Mohler/Crime discovery/la_crime_data/result/GWR_ERRORSLM_all_variables/actual crimes in space.png")
...
ggsave("C:/Users/Samira/Dropbox/Dr Mohler/Crime discovery/la_crime_data/result/GWR_ERRORSLM_all_variables/linear crimes in space.png")
...
ggsave("C:/Users/Samira/Dropbox/Dr Mohler/Crime discovery/la_crime_data/result/GWR_ERRORSLM_all_variables/gwr crimes in space.png")
...
for (i in loop.vector) { # Loop over loop.vector
  ...
  url = paste("C:/Users/Samira/Dropbox/Dr Mohler/Crime discovery/la_crime_data/result/GWR_ERRORSLM_all_variables/", paste(new_name, "png", sep = "."), sep="")
  ggsave(url)
  #print(url)
  #break
} 
