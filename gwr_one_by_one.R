...
raw_data$income <- index_data$income
scaled_data$population <- index_data$population

#dataset <- count(raw_data, vars = colnames(raw_data)) ###ONLY raw DATA#########
...
#flm<-as.formula("crimes_shannon_index ~ income+population")
#flm<-as.formula("crimes_shannon_index ~ income+population + race_shannon_index")
#flm<-as.formula("crimes_shannon_index ~ income+population + race_shannon_index+language_shannon_index")
flm<-as.formula("crimes_shannon_index ~ income+population + race_shannon_index+language_shannon_index+household_shannon_index")
